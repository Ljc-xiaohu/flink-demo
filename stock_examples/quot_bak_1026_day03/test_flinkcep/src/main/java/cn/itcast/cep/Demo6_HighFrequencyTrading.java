...
public class Demo6_HighFrequencyTrading {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(df.format(new Date(1597905234000L)));
        System.out.println(df.format(new Date(1597905235000L)));
        System.out.println(df.format(new Date(1597905236000L)));
        System.out.println(df.format(new Date(1597905237000L)));
        System.out.println(df.format(new Date(1597905238000L)));
        System.out.println(df.format(new Date(1597905239000L)));
        System.out.println(df.format(new Date(1597905240000L)));
        System.out.println(df.format(new Date(1597905241000L)));
