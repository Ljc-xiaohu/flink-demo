...
public class StockStreamApplication {
    public static void main(String[] args) throws Exception {
        ...
        //4.设置Checkpoint机制-学习时开发时可以注掉,上线再打开
        /*//=================建议必须设置的===================
        ...
        //sseKafkaConsumer.setStartFromGroupOffsets();//从group offset记录的位置位置开始消费,如果kafka broker 端没有该group信息，会根据"auto.offset.reset"的设置来决定从哪开始消费
        sseKafkaConsumer.setStartFromEarliest();
        //sseKafkaConsumer.setCommitOffsetsOnCheckpoints(true);//Flink执行Checkpoint的时候提交偏移量(一份在Checkpoint中,一份在Kafka的默认主题中__comsumer_offsets(方便外部监控工具去看))
        ...
        //szseKafkaConsumer.setStartFromGroupOffsets();
        szseKafkaConsumer.setStartFromEarliest();
        //szseKafkaConsumer.setCommitOffsetsOnCheckpoints(true);
