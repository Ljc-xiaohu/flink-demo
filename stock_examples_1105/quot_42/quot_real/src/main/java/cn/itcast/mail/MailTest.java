...
public class MailTest {
    public static void main(String args[]){
         ...
         * 这里发件人 要写全名
         */
        //TODO 改成自己的发件人用户名要加后缀
        String from = "mailtestsender@163.com";//发件人的邮箱 全名 加后缀

        /**
         * 收件人 同样要写全名
         */
        //TODO 改成自己的收件人用户名要加后缀
        String to = "mailtestreceiver@163.com";//收件人的邮箱

        /**
         * 主题自定义
         */
        String subject = "邮件测试20201030~";//邮件主题
        /**
         * 自定义
         */
        String content = "测试成功20201030~";//邮件的内容
         ...
         */
        MailBean mail = new MailBean(from, to,subject,content);
        try {
            /**
