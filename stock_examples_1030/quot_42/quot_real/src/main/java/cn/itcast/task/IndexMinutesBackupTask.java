...
public class IndexMinutesBackupTask implements ProcessDataInterface {
    ...
    public void process(DataStream<CleanBean> waterData) {
        ...
        */
        ...
        bucketingSink.setPendingPrefix("index2_");//挂起状态的前缀
        //后缀
        ...
        //5.数据处理 .apply(new IndexMinutesWindowFunction())
        .apply(new IndexMinutesWindowFunction())
        //6.转换数据:设置分割符并进行数据拼接.map(new IndexPutHDFSMapFunction())
